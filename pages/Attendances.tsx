...
// Badge de status de pagamento com tooltip de resumo (via portal, para não ser
// cortado pelo overflow-hidden do card nem pelo scroll da lista).
const PaymentSummaryBadge: React.FC<{ apt: Appointment }> = ({ apt }) => {
