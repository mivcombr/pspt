        ...
        <div className="flex-1 flex flex-col justify-center p-8 sm:p-12 lg:p-16 bg-white dark:bg-[#151f2e]">
          <div className="w-full max-w-sm mx-auto">
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              ...
              <div className="group">
                <label className="block text-xs font-bold text-slate-500 mb-1.5 ml-1 transition-colors group-focus-within:text-primary">E-mail</label>
                <input
                  type="email"
                  required
                  value={email}
              ...
              <div className="group">
                <label className="block text-xs font-bold text-slate-500 mb-1.5 ml-1 transition-colors group-focus-within:text-primary">Senha</label>
                <input
                  type="password"
                  required
                  value={password}
              ...
              <div className="flex justify-end">
                <Link to="/forgot-password" className="text-xs font-bold text-primary hover:text-primary-hover hover:underline transition-colors">
                  Esqueci minha senha
                </Link>
              </div>
